...
function Navbar(){
    return(
        <div className=' bg-[#106EBE] text-[#0FFCBE] border border-black-400 border-1'>
            ...
            {/* Navbar */}
            <div className="logo w-screen h-24 flex justify-between items-center px-4 border border-red-400 border-1">
            ...
            <div className='searchBar flex justify '>
                ...
                className='bg-white rounded-full text-black p-1 text-center ' />
            </div>
